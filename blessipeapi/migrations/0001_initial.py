# Generated by Django 3.2.7 on 2021-09-22 22:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='blessipeapi.city')),
        ...
        migrations.AddField(
            ...
            name='keywords',
            field=models.ManyToManyField(blank=True, related_name='restaurant_keywords', through='blessipeapi.RestaurantKeyword', to='blessipeapi.Keyword'),
        ),
        migrations.AddField(
            model_name='restaurant',
            name='super_fans',
            field=models.ManyToManyField(related_name='favorited', through='blessipeapi.Favorite', to='blessipeapi.Traveler'),
        ),
        migrations.CreateModel(
            name='RecipeKeyword',
            fields=[
        ...
        migrations.AddField(
            model_name='recipe',
            name='keywords',
            field=models.ManyToManyField(blank=True, related_name='recipe_keywords', through='blessipeapi.RecipeKeyword', to='blessipeapi.Keyword'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='restaurant',
